...
class SferaHelperApplication {
		public static void main(String... args) throws IOException {
			...
			//String query = "area=\"FRNRSA\" and status not in ('closed', 'done', 'rejectedByThePerformer') and parent='STROMS-4062'";
			...
			for (ListTicketShortDto ticket: listTicketsDto.getContent()) {
				...
				//SferaHelperMethods.setParent(ticket.getNumber(), "STROMS-4792");
